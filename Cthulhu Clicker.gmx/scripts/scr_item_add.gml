...
ds_grid_resize(store,12,temp+1);
...
ds_grid_add(store, 9, temp, argument9);    //x-parameter
ds_grid_add(store, 10, temp, argument10);  //y-parameter
ds_grid_add(store, 11, temp, argument11);  //sprite
